...
export class FinalMigration1691383764749 implements MigrationInterface {
    name = 'FinalMigration1691383764749'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "employees" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "username" character varying NOT NULL, "age" integer, "password" character varying NOT NULL, "experience" integer NOT NULL, "joining_date" character varying NOT NULL, "role" character varying NOT NULL DEFAULT 'Developer', "department_id" integer, CONSTRAINT "PK_b9535a98350d5b26e7eb0c26af4" PRIMARY KEY ("id"))`);
